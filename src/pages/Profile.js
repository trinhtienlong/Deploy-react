              ...
              <div className="main-profile ">
                <div className="row">
                  <div className="col-lg-4">
                    <img src="assets/images/profile.jpg" alt="" style={{borderRadius: "23px"}}/>
                  </div>
                    ...
                    <div className="clips">
                      <div className="row">
                        ...
                        <div className="col-lg-3 col-sm-6">
                          <div className="item">
                            <div className="thumb">
                              <img src="assets/images/clip-01.jpg" alt="" style={{borderRadius: "23px"}}/>
                        ...
                        <div className="col-lg-3 col-sm-6">
                          <div className="item">
                            <div className="thumb">
                              <img src="assets/images/clip-02.jpg" alt="" style={{borderRadius: "23px"}}/>
                              <Link to="https://www.youtube.com/watch?v=r1b03uKWk_M" target="_blank"><i className="fa fa-play"></i></Link>
                            </div>
                            <div className="down-content">
                              <h4>Second Clip</h4>
                        ...
                        <div className="col-lg-3 col-sm-6">
                          <div className="item">
                            <div className="thumb">
                              <img src="assets/images/clip-03.jpg" alt="" style={{borderRadius: "23px"}}/>
                              <Link to="https://www.youtube.com/watch?v=r1b03uKWk_M" target="_blank"><i className="fa fa-play"></i></Link>
                            </div>
                            <div className="down-content">
                              <h4>Third Clip</h4>
                        ...
                        <div className="col-lg-3 col-sm-6">
                          <div className="item">
                            <div className="thumb">
                              <img src="assets/images/clip-04.jpg" alt="" style={{borderRadius: "23px"}}/>
                              <Link to="https://www.youtube.com/watch?v=r1b03uKWk_M" target="_blank"><i className="fa fa-play"></i></Link>
                            </div>
                            <div className="down-content">
                              <h4>Fourth Clip</h4>
